...
Ship = function () {
  ...
  this.collision = function (other) {
    ...
    console.log(nomeUsuario)
    const Pontos = Game.score;
    //// SALVAR
    axios.post('http://localhost:5000/api/pontuacao', { username: nomeUsuario , pontuacao: Pontos, idJogo: 1 })
        .then(response => {
...
Game = {
  ...
  FSM: {
    ...
    waiting: function () {
      Text.renderText(window.ipad ? 'Touch Screen to Start' : 'precione espaco para jogar', 37, Game.canvasWidth/2 - 360, Game.canvasHeight/2);
